...
describe("CustomPagination", () => {
  test("should render componet with defaults values", () => {
  ...
  test("should disables previous button when page is 1", () => {
    renderWithRouter(<CustomPagination totalPages={5} />);
  ...
  test("should disables previous button when page is the last page", () => {
  ...
  test("should disables button 3 when we are in page 3", () => {
